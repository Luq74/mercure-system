...
-- ==========================================
-- BAGIAN 1: STORAGE SETUP (PENTING!)
-- ==========================================
-- Supabase Storage tidak bisa dibuat via SQL script standar ini dengan mudah karena permission.
-- Silakan buat MANUAL di Dashboard Supabase:
-- 1. Buka menu "Storage" di sidebar kiri.
-- 2. Klik "New Bucket".
-- 3. Beri nama bucket: "images" (tanpa tanda kutip, huruf kecil semua).
-- 4. Pastikan "Public bucket" dicentang (ON).
-- 5. Klik "Save".
-- 6. Setelah bucket jadi, masuk ke tab "Configuration" > "Policies".
-- 7. Tambahkan Policy baru untuk bucket "images":
--    - Klik "New Policy" -> "For full customization".
--    - Name: "Allow Public Access"
--    - Allowed operations: Centang SELECT, INSERT, UPDATE, DELETE (Semua).
--    - Target roles: Centang "anon" dan "authenticated".
--    - Klik "Review" lalu "Save".

-- ==========================================
-- BAGIAN 2: TABLE SETUP
-- ==========================================
